...
const React2: any = React;
export default React2.createClass({
  propTypes: {
    height: React2.PropTypes.number,
    width: React2.PropTypes.number,
    upArrow: React2.PropTypes.number,
    downArrow: React2.PropTypes.number,
    ballSize: React2.PropTypes.number,
    paddleHeight: React2.PropTypes.number,
